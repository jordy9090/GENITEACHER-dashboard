...
function ClassDetailPage({ classId, className, onBack, onNavigateToStudentList, onNavigateToStudent, onNavigateToAchievementAnalysis }: ClassDetailPageProps) {
    ...
    <div style={{ 
      ...
      {onNavigateToAchievementAnalysis && (
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '15px' }}>
          <button
            onClick={() => onNavigateToAchievementAnalysis(classId, className)}
            style={{
              padding: '10px 20px',
